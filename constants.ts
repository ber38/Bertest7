...
export const SUBJECTS: Subject[] = [
  {
    ...
    icon: React.createElement(MathIcon, { className: 'h-8 w-8 text-white' }),
    modules: [
      {
  ...
  },
  {
    ...
    icon: React.createElement(FrenchIcon, { className: 'h-8 w-8 text-white' }),
    modules: [
       {
        id: 'grammaire',
  ...
  },
  {
    ...
    icon: React.createElement(ScienceIcon, { className: 'h-8 w-8 text-white' }),
    modules: [
       {
        id: 'cycle-de-vie',
  ...
  },
  {
    ...
    icon: React.createElement(HistoryIcon, { className: 'h-8 w-8 text-white' }),
    modules: [
      {
        id: 'grandes-periodes',
